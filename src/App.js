...
const THEMES = {
  ...
  sky: {
    ...
    dark: false,
    bg: {
      base:'linear-gradient(158deg,#B8DCFF 0%,#C8DEFF 12%,#D8E4FF 28%,#E4E8FF 45%,#EDE8FF 62%,#E2EFFF 80%,#CCE8FF 100%)',
      fog:['rgba(56,189,248,0.38)','rgba(99,102,241,0.30)','rgba(168,85,247,0.24)'],
      orbs:['rgba(56,189,248,0.55)','rgba(99,102,241,0.48)','rgba(168,85,247,0.42)','rgba(125,211,252,0.52)'],
      mtn1:'#4D8FDB', mtn2:'#7AB5F0', mtn3:'#A8D0FF', ridge:'#4338CA',
      skySrc:['#3A7DD0','#7BBCF0'], sunC:'#FFF3DC',
      stars:['#A855F7','#2563EB','#4F46E5','#3B82F6'],
      aurora:true, auroraColors:['rgba(56,189,248,0.22)','rgba(99,102,241,0.18)','rgba(168,85,247,0.14)'],
      rays:true,
    },
    C: {
